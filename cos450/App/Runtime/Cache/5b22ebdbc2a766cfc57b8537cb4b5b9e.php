				...
				<div class="left block_n block_d">
					...
					<div class="lh24" style="margin-left:354px;">
						...
						<div class="lwf mb10">
							...
							<div class="left mr20">
								<input type="text" id="startDate" name="startDate" style="width:90px;" onclick="opcal();" value=""/>
						...
						<div class="lwf mb10"> <div class="left" style="width:120px;">结束时间：</div>
							<div class="left">
								<input type="text" id="endDate" name="endDate"  style="width:90px;" onclick="opcal();" value=""/>
...
<script src="__JS__/date/lhgcalendar/lhgcore.min.js" type="text/javascript"></script>
<script src="__JS__/date/lhgcalendar/lhgcalendar.min.js" type="text/javascript"></script>
<script src="__JS__/date/lhgcalendar/openlhgcalendar.js" type="text/javascript"></script>
